...
public class SwitchView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		paint.setColor(isOn ? getResources().getColor(R.color.main_color) : getResources().getColor(R.color.switch_no_check));
		...
		paint.setColor(getResources().getColor(R.color.switch_no_check));
		canvas.drawPath(sPath, paint);
		canvas.restore();
		// draw center bar
		canvas.save();
		...
		paint.setColor(isOn ? getResources().getColor(R.color.main_color) : 0xffbfbfbf);
		canvas.drawPath(bPath, paint);
