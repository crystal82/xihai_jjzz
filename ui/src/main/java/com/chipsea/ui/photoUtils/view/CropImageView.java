            ...
            case MotionEvent.ACTION_MOVE:
                if (mStatus == STATUS_TOUCH_MULTI_TOUCHING) {
                    ...
                    if (!(dx == 0 && dy == 0)) {
                        ...
                        switch (currentEdge) {
                            case EDGE_LT:
                                mDrawableFloat.set(mDrawableFloat.left + toMoveOf, mDrawableFloat.top + toMoveOf, mDrawableFloat.right, mDrawableFloat.bottom);
                                break;

                            case EDGE_RT:
                                if (toMoveOf == dy){
                                    mDrawableFloat.set(mDrawableFloat.left, mDrawableFloat.top + toMoveOf, mDrawableFloat.right - toMoveOf, mDrawableFloat.bottom);
                                    break;
                                }
                                else{
                                    mDrawableFloat.set(mDrawableFloat.left, mDrawableFloat.top - toMoveOf, mDrawableFloat.right + toMoveOf, mDrawableFloat.bottom);
                            ...
                            case EDGE_LB:
                                if (toMoveOf == dx){
                                    mDrawableFloat.set(mDrawableFloat.left + toMoveOf, mDrawableFloat.top, mDrawableFloat.right, mDrawableFloat.bottom - toMoveOf);
                                    break;
                                }
                                else{
                                    mDrawableFloat.set(mDrawableFloat.left - toMoveOf, mDrawableFloat.top, mDrawableFloat.right, mDrawableFloat.bottom + toMoveOf);
                            ...
                            case EDGE_RB:
                                mDrawableFloat.set(mDrawableFloat.left, mDrawableFloat.top, mDrawableFloat.right + toMoveOf, mDrawableFloat.bottom + toMoveOf);
                                break;
