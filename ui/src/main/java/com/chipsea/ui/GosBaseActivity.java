...
import chipsea.wifiplug.lib.MessageCenter;
...
public class GosBaseActivity extends FragmentActivity {
     ...
     * 设备热点默认密码
     */
    public static String SoftAP_PSW = "12345678";
     ...
     * 存储器默认名称
     */
    public static final String SPF_Name = "Xinhai";
    ...
    public void setActionBar(Boolean HBE, Boolean DSHE, int Title) {
        ...
        ssTitle.setSpan(new RelativeSizeSpan(1.2f), 0, ssTitle.length(),
                        Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
        actionBar = getActionBar();// 初始化ActionBar
        actionBar.setBackgroundDrawable(GosDeploy.setNavigationBarColor(R.color.main_color));
    ...
    public void setProgressDialog() {
        progressDialog = LoadDialog.getShowDialog(this);
